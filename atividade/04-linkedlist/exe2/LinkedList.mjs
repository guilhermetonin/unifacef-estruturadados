...
Regras:
1. Após chamar reverse(), o primeiro elemento vira o último e vice-versa.
2. A lista original é modificada — sem criar outra lista.
3. Teste a funcionalidade com print() antes e depois de inverter.
*/
