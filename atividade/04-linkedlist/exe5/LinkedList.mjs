...
Regras:
1. O método deve retornar um array com os dados dos nós na ordem correta.
2. Utilize esse array para facilitar comparações e visualização.
3. Teste imprimindo o array retornado.
*/
