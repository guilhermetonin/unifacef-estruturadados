...
Desafio: Crie um método countOccurrences(val) que conta quantas vezes um valor aparece na 
lista.
1. O método deve percorrer toda a lista.
2. Retorna um número representando a quantidade de vezes que val aparece.
3. Teste com inserções repetidas de um mesmo valor.
*/
