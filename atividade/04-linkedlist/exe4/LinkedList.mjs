...
Regras:
1. Percorra a lista e remova cada ocorrência de val.
2. Ajuste os ponteiros corretamente após cada remoção.
3. Teste com uma lista contendo vários valores repetidos.
*/
